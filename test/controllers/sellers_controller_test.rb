...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { city: @seller.city, country: @seller.country, director_firstname: @seller.director_firstname, director_lastname: @seller.director_lastname, email: @seller.email, internal_comment: @seller.internal_comment, name: @seller.name, phone: @seller.phone, postal_code: @seller.postal_code, thorougfare: @seller.thorougfare } }
    end
